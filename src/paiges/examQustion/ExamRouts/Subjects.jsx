...
const Subjects = () => {
  ...
  const handleStartQuiz = async (id) => {
    ...
    try {
      ...
      const res = await fetch("https://study-plan-backend-beta.vercel.app/generate-quiz", {
        method: "POST",
  ...
  const handelDelet = async (id) => {
    const res = await fetch(`https://study-plan-backend-beta.vercel.app/quizData/${id}`, {
      method: "DELETE",
    });
              ...
              <div className="flex items-center gap-2 mt-auto">
                ...
                >
                  <button
                    ...
                    className="flex items-center w-full justify-center gap-2 bg-purple-500 hover:bg-purple-600 text-white flex-1 px-4 py-2 rounded-lg"
                  >
